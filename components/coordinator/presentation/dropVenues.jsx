...
function SearchableDropdownListVenue() {
  ...
  return (
    <div className="relative z-1">
      ...
      {isOpen && (
        <ul className="ulListoption top-18 left-0 right-0 z-1 border border-gray-300 bg-white">
          <span
...
export default SearchableDropdownListVenue;
