...
import { DeleteStudentFromProjectByCoordinator } from "../../../../redux/features/coordinator/coordinator_slice";
const DeleteConfirmation = ({ postId, onDelete, projectId }) => {
  ...
  const handleDelete = () => {
    ...
    dispatch(DeleteStudentFromProjectByCoordinator(data));
